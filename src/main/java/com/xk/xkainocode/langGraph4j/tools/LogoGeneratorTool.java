package com.xk.xkainocode.langGraph4j.tools;
...
import com.xk.xkainocode.langGraph4j.model.enums.ImageCategoryEnum;
...
public class LogoGeneratorTool {
    ...
    @Value("${dashscope.image-model:wanx2.0-t2i-turbo}")
    ...
    public List<ImageResource> generateLogos(@P("Logo 设计描述，如名称、行业、风格等，尽量详细") String description) {
        ...
        try {
            ...
            // todo 注意这里生成的 url会在24小时内过期，后续可以把 url上传到 Cos对象存储做一个持久化
