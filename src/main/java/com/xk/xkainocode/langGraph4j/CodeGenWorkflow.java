package com.xk.xkainocode.langGraph4j;

import com.xk.xkainocode.exception.BusinessException;
import com.xk.xkainocode.exception.ErrorCode;
import com.xk.xkainocode.langGraph4j.model.QualityResult;
import com.xk.xkainocode.langGraph4j.node.*;
...
public class CodeGenWorkflow {
    ...
    private String routeAfterQualityCheck(MessagesState<String> state) {
        ...
        if(generationType.equals(CodeGenTypeEnum.HTML) || generationType.equals(CodeGenTypeEnum.MULTI_FILE)){
            return "skip_build";
        }
        return "build";
    }
