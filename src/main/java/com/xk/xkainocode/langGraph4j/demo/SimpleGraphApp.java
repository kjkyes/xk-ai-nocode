package com.xk.xkainocode.langGraph4j.demo;
...
public class SimpleGraphApp {
    ...
    public static void main(String[] args) throws GraphStateException {
       ...
       var stateGraph = new StateGraph<>(SimpleState.SCHEMA, initData -> new SimpleState(initData))
        ...
        // 展示工作流图的结构（以mermaid这种文本绘图语法）
        GraphRepresentation demo = stateGraph.getGraph(GraphRepresentation.Type.MERMAID, "demp");
